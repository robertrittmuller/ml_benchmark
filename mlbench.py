...
display_output(envData,'Resnet50 Fine Tuning Test', test3(1, feature_extractor_model="https://tfhub.dev/tensorflow/resnet_50/feature_vector/1"))
display_output(envData,'MobilenetV2 Fine Tuning Test', test3(1, feature_extractor_model="https://tfhub.dev/google/tf2-preview/mobilenet_v2/feature_vector/4")) 
